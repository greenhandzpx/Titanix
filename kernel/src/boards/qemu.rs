...
pub const MMIO: &[(usize, usize, MapPermission)] = &[
    ...
    (0x10002000, 0x1000, PERMISSION_RW),   // VIRTIO0
    (0x10003000, 0x1000, PERMISSION_RW),   // VIRTIO0
    (0x10004000, 0x1000, PERMISSION_RW),   // VIRTIO0
    (0x10005000, 0x1000, PERMISSION_RW),   // VIRTIO0
    (0x10006000, 0x1000, PERMISSION_RW),   // VIRTIO0
    (0x10007000, 0x1000, PERMISSION_RW),   // VIRTIO0
    (0x10008000, 0x1000, PERMISSION_RW),   // VIRTIO0
