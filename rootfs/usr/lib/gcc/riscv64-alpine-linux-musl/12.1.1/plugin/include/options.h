...
enum opt_code
{
  ...
  OPT_mbranch_cost_ = 1770,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1771,                       /* -mcmodel= */
  OPT_mcpu_ = 1772,                          /* -mcpu= */
  OPT_mdiv = 1773,                           /* -mdiv */
  OPT_mexplicit_relocs = 1774,               /* -mexplicit-relocs */
  OPT_mfdiv = 1775,                          /* -mfdiv */
  OPT_mglibc = 1776,                         /* -mglibc */
  OPT_misa_spec_ = 1777,                     /* -misa-spec= */
  OPT_mlittle_endian = 1778,                 /* -mlittle-endian */
  OPT_mmusl = 1779,                          /* -mmusl */
  OPT_mplt = 1780,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1781,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1782,                         /* -mrelax */
  OPT_mriscv_attribute = 1783,               /* -mriscv-attribute */
  OPT_msave_restore = 1784,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1785,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1786,             /* -msmall-data-limit= */
  ...
  OPT_mtune_ = 1791,                         /* -mtune= */
  OPT_muclibc = 1792,                        /* -muclibc */
  OPT_n = 1793,                              /* -n */
  OPT_name_sort = 1794,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1795,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1796,              /* -no-integrated-cpp */
  OPT_no_pie = 1797,                         /* -no-pie */
  OPT_nocpp = 1798,                          /* -nocpp */
  OPT_nodefaultlibs = 1799,                  /* -nodefaultlibs */
  OPT_nolibc = 1800,                         /* -nolibc */
  OPT_nophoboslib = 1801,                    /* -nophoboslib */
  OPT_nostartfiles = 1802,                   /* -nostartfiles */
  OPT_nostdinc = 1803,                       /* -nostdinc */
  OPT_nostdinc__ = 1804,                     /* -nostdinc++ */
  OPT_nostdlib = 1805,                       /* -nostdlib */
  OPT_o = 1806,                              /* -o */
  OPT_objects = 1807,                        /* -objects */
  OPT_p = 1808,                              /* -p */
  OPT_pass_exit_codes = 1809,                /* -pass-exit-codes */
  /* OPT_pedantic = 1810, */                 /* -pedantic */
  OPT_pedantic_errors = 1811,                /* -pedantic-errors */
  OPT_pg = 1812,                             /* -pg */
  OPT_pie = 1813,                            /* -pie */
  OPT_pipe = 1814,                           /* -pipe */
  OPT_posix = 1815,                          /* -posix */
  OPT_print_file_name_ = 1816,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1817,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1818,          /* -print-multi-directory */
  OPT_print_multi_lib = 1819,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1820,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1821,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1822,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1823,               /* -print-prog-name= */
  OPT_print_search_dirs = 1824,              /* -print-search-dirs */
  OPT_print_sysroot = 1825,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1826,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1827,                    /* -print-value */
  OPT_profile = 1828,                        /* -profile */
  OPT_pthread = 1829,                        /* -pthread */
  OPT_quiet = 1830,                          /* -quiet */
  OPT_r = 1831,                              /* -r */
  OPT_rdynamic = 1832,                       /* -rdynamic */
