...
use crate::{config::{board::MEMORY_END, mm::{KERNEL_DIRECT_OFFSET, PAGE_SIZE_BITS}}, sync::mutex::SpinNoIrqLock};
...
pub fn init_frame_allocator() {
    ...
    info!("frame allocator init finshed, start {:#x}, end {:#x}", ekernel as usize, MEMORY_END);
}
/// allocate a frame
